...
const Home = () => {
  ...
  return (
    ...
    <Navbar />
    <Container className='w-full h-[600px] flex flex-col items-center gap-5 bg-wavy bg-cover bg-center py-40'>
      <p className='text-5xl text-black dark:text-white font-black'>Hi, I'm Samson</p>
      <p className='w-full md:w-1/2 text-black dark:text-white text-lg font-bold text-center'>
    ...
    <Container className='w-full flex flex-col text-black dark:text-white py-10'>
      ...
      <p className='w-full md:w-1/2 text-gray-500 font-semibold my-5'>
