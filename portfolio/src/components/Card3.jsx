...
const Card3 = ({name, description, company, url, image}) => {
  return (
    <div className='w-[320px] max-w-full h-[400px] relative'>
      <div className='w-[320px] max-w-full h-[400px] flex flex-col gap-3 py-2 px-4 bg-white absolute top-0 left-0 z-[1] top-card'>
      ...
      <div className='w-[320px] max-w-full h-[400px] bg-gray-400 absolute top-2 left-2 shadow-card transition-all duration-500 ease-in-out'></div>
    </div>
  )
}
