    ...
    return (
        <section className={styles.section} id="about">
            ...
            <div className={styles.about}>
                ...
                I also love reading a lot. I like pop music and good food. I recently fell in love with writing and I&apos;ve written a some articles with a few in my draft.</p>
            </div>
        </section>
    )
}
